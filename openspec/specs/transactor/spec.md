...
Defines the Transactor abstraction that allows the usecase layer to coordinate writes across multiple repositories in a single atomic database transaction, without exposing a database handle to the usecase.
