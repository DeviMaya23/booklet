...
Defines the rules for retrieving available Bookleaf public folders for the authenticated user, including the proxy behaviour and the Bookleaf HTTP client configuration.
