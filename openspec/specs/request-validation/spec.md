...
Defines how HTTP request bodies are validated across the API — including the validation library, error response shape, field naming convention, and human-readable error messages.
