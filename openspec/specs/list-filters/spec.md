...
Defines the freetext search and multi-value ID filter requirements shared across list endpoints. These capabilities allow users to narrow results by name/title substring or by associated entity IDs.
